...
const Header: React.FC = () => {
  ...
  "
            >
              <span className="text-custom-text-title">Adquira</span> Seu Novo
              Veiculo,{" "}
              <span className="text-custom-text-title">Negocie à Vista</span> e
              Parcele Sem Juros. Utilize Seu{" "}
              <span className="text-custom-text-title">Automóvel</span>,{" "}
              <span className="text-custom-text-title">Moto</span> ou{" "}
              <span className="text-custom-text-title">Utilitário</span> Como
              Parte do Pagamento
            </h1>
